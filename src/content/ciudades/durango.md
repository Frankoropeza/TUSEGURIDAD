...
normativa:
  ...
  modalidades: 7
  modalidadesArticulo: "Art. 16"
  registro: "Registro Estatal de Empresas, Personal y Equipo de Seguridad Privada"
  sinLeyEspecifica: false
fuentes:
  - titulo: "Ley de Seguridad Privada para el Estado de Durango"
    url: "https://congresodurango.gob.mx/Archivos/legislacion/LEY%20DE%20SEGURIDAD%20PRIVADA.pdf"
---

Consultar un proveedor de seguridad privada en **Durango** exige revisar el marco local: la autorización se otorga por entidad y por modalidad, y las reglas cambian de un estado a otro.
