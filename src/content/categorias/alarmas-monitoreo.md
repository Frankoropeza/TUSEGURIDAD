...
modalidades:
  - nombre: Alarma contra intrusión
    descripcion: Sensores de movimiento y apertura, sirenas y panel de control para detectar la entrada no autorizada a un inmueble.
  - nombre: Monitoreo 24/7
    descripcion: Central que recibe las señales del panel, verifica el evento y lo escala según protocolo — llamada, notificación o aviso a autoridades. Es el corazón del servicio.
  - nombre: Botón de pánico
    descripcion: Dispositivo fijo o móvil que dispara una señal de auxilio silenciosa a la central. Común en comercios y traslados.
  - nombre: Respuesta a eventos
    descripcion: Algunos proveedores ofrecen verificación en sitio con personal propio; esa operación es vigilancia y debe estar amparada por la autorización de seguridad privada correspondiente.

verificacion:
  - punto: Modalidad amparada
    detalle: La ley federal trata la instalación de alarmas y la administración de sus señales como modalidad de seguridad privada. Pide la autorización del proveedor y confirma que esa modalidad aparezca expresamente.
  - punto: Central propia o subcontratada
    detalle: Pregunta quién monitorea en realidad tus señales. Si la central es de un tercero, el contrato debe decirlo y definir quién responde por una falla de respuesta.
  - punto: Protocolo de escalamiento
    detalle: Qué pasa cuando suena la alarma, en qué orden llaman, a quién y en cuánto tiempo. Debe quedar por escrito; "le marcamos" no es un protocolo.
  - punto: Prueba periódica del sistema
    detalle: Panel y sensores requieren pruebas regulares con la central. Confirma la periodicidad y que cada prueba deje registro.
  - punto: Falsas alarmas y mantenimiento
    detalle: Los sensores mal instalados generan falsas alarmas que terminan en respuestas ignoradas. El contrato debe cubrir recalibración y mantenimiento del equipo.

faq:
  - q: ¿La empresa de alarmas necesita permiso de seguridad privada?
    a: La Ley Federal de Seguridad Privada reconoce la instalación de sistemas de alarma y la administración de las señales que generan como una de sus modalidades. Según el territorio donde opere, al proveedor le aplica la autorización federal o el permiso local, con esa modalidad amparada.
  - q: ¿Qué diferencia hay entre comprar una alarma y contratar monitoreo?
    a: La alarma sola avisa en el sitio; el monitoreo conecta el sistema a una central que verifica y escala el evento aunque no haya nadie en el inmueble. El valor del servicio está en la respuesta, no en el equipo.
  - q: ¿Sirve una alarma sin línea telefónica o internet?
    a: Los paneles actuales comunican por chip celular, internet o ambos como respaldo. Al contratar, pregunta qué vías usa el panel y qué pasa si una falla — la comunicación redundante es lo que mantiene el servicio vivo.
